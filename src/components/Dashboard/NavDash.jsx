...
export default function NavDash() {
  return (
    <aside className="flex flex-col gap-8 justify-between items-center pt-4 min-h-screen bg-secondary w-36 text-white">
      <nav className="flex flex-col gap-4  ">
        <div className="w-32 bg-white flex justify-center items-center h-18 rounded-lg text-black">
          <span className="text-center font-bold">Yazid y Abi</span>
        </div>

        <a className="flex cursor-pointer w-full px-3 py-4 hidden:inline hover:bg-white hover:text-black rounded-lg transition-colors">
          <DashIcon />
          <span>DashBoard</span>
        </a>
        <a className="flex cursor-pointer w-full px-3 py-4 hidden:inline hover:bg-white hover:text-black rounded-lg transition-colors">
